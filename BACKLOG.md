...
|-------|--------|-------|----|
| v74.39 | (pending) | 2026-05-19 | **Music master toggle — default OFF.** Adaptive music (kick/hihat/clap/pad/belt_tick) je teď opt-in. `_musicEnabled` flag perzistovaný v localStorage `bb-music`. Toggle v dev overlay (⚙) — "🎵 Hudba" pill vedle Safe zone. Default SFX (pop/bounce/shoot/step) běží na full vol jak před adaptive music. Plus clap volume -30% (0.90 → 0.63). |

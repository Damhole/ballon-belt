...
|-------|--------|-------|----|
| v74.33 | (pending) | 2026-05-19 | **Pop fatigue volume drop + throttle 200ms.** V rychlé sérii popů gain klesá -25% per consecutive (1.0 → 0.75 → 0.56 → ... floor 0.05). Reset na full po >1s pauze. Throttle 60→200ms aby se popy nepřekrývaly a každý dB drop byl jasně slyšet. |

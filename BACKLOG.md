...
|-------|--------|-------|----|
| v73.345 | (pending) | 2026-05-18 | **Plop! v UI sjednoceno s version fontem.** Bangers @import + comic style v `#version-badge` odstraněno. Plop! teď používá stejný `var(--font-sans)` jako version number, jen `font-weight: 600`. Comic font zůstává jen v ikoně (PWA install). |

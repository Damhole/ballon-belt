...
|-------|--------|-------|----|
| v74.32 | (pending) | 2026-05-19 | **Pop: měkčí výšky.** `_wireAndPlay` přijímá volitelný per-zvuk lowpass cutoff. Pop dostal vlastní lowpass na 1000Hz (vs globální 2500Hz na bus) → tlumené výšky, jemnější transient. Ostatní zvuky beze změny. |
